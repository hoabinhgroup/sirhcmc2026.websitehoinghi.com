...
use App\Services\AbstractSubmissionExcelExportService;
...
class ExportAbstractSubmissionsAction extends Action
{
    ...
    protected function setUp(): void
    {
        ...
        $this->color('gray');
        $this->modalHeading('Xuất danh sách abstract');
        ...
        $this->form([
            Fieldset::make('Cột xuất Excel')
                ...
                ->statePath('columnMap')
                ->schema(
                    collect(AbstractSubmissionExporter::getColumns())
        ...
        $this->action(function (array $data, HasTable $livewire) {
            ...
            return app(AbstractSubmissionExcelExportService::class)->download(
