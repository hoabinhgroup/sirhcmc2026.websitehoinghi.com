  ...
  <section class="latest-blog spad">
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="latest-item set-bg large-item" data-setbg="{{ Storage::url('img/blog/latest-b/latest-1.jpg')}}">
        ...
        <div class="col-lg-6">
          <div class="latest-item set-bg" data-setbg="{{ Storage::url('img/blog/latest-b/latest-2.jpg')}}">
          ...
          <div class="latest-item set-bg" data-setbg="{{ Storage::url('img/blog/latest-b/latest-3.jpg')}}">
            <div class="li-tag">Marketing</div>
            <div class="li-text">
